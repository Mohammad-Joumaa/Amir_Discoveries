...
export default function CallBookingPage() {
  ...
  const { currentTime, timeZoneName, isLoadingTime } =
    useCurrentTime(selectedTimeZone);
        ...
        <div className="w-1/2 bg-white p-8 flex flex-col">
          ...
          <div className="flex-1">
            ...
            <div className="text-gray-700 space-y-4">
              ...
              <p className="mt-4">
                We look forward to helping you take your business to the next
                level with the power of Automation and AI.
              </p>
            </div>
          </div>
        </div>
