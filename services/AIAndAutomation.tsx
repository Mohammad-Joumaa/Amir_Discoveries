      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {[
              "TensorFlow", "PyTorch", "OpenAI", "Google AI", "Microsoft Azure", "AWS ML",
              "Hugging Face", "DeepMind Gemini", "Open Router", "N8N", "Ollama", "Automation Anywhere"
            ].map((tech, index) => (
              <div 
                key={index} 
                className="text-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 fade-in"
                style={{ animationDelay: `${0.1 + index * 0.05}s` }}
              >
                <div className="h-12 w-12 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg mx-auto mb-2 flex items-center justify-center">
